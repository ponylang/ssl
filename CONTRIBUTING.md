...
You want to contribute to ssl? Awesome.
...
First of all please [search existing issues](https://github.com/ponylang/ssl/issues) to make sure your issue hasn't already been reported. If you cannot find a suitable issue — [create a new one](https://github.com/ponylang/ssl/issues/new).
